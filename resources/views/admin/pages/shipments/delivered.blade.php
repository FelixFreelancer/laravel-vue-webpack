...
@section('content')
    ...
    @include('admin.popups.delivered')
@stop
...
@section('contentFooter')
    ...
    <script>
        ...
        $(document).on('click', '#submit_delivered', function (e) {
            e.preventDefault();
            if($("#delivered_at").val() != ''){
              $.ajax({
                dataType: 'json',
                method: 'post',
                data: 'delivered_at='+$("#delivered_at").val()+'&id='+$("#id").val(),
                url: adminURL + "shipment/delivered",
              ...
              $(".delivered_at_error").html("Delivered date is required");
            }
        });
