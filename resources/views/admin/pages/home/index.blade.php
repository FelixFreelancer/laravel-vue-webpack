...
@section('content')
    <!--Begin::Section-->
    <div class="row">
        {{--@if(auth()->user()->hasRole('user') && $indicators->count()>0)--}}
        {{--<div class="col-xl-4">--}}
        ...
        {{--<!--begin::Widget5-->--}}
        {{--<div class="m-widget4">--}}
        {{--<form id="js--achievement-form">--}}
        {{--<div class="col-lg-12">--}}
        {{--<div class="form-group m-form__group row">--}}
        {{--{!!Form::label('indicator_id','Indicator')!!}--}}
        {{--{!!Form::select('indicator_id',$indicators,old('indicator_id'),['class'=>'form-control','id'=>'indicators_select','placeholder'=>'Select Indicator'])!!}--}}
        {{--</div>--}}
        {{--<div class="form-group m-form__group row">--}}
        {{--{!!Form::label('target_achieved','Target Achieved')!!}--}}
        {{--{!!Form::number('target_achieved', old('target_achieved'), ['class'=>'form-control','placeholder'=>'Target Achieved','min'=>'0'])!!}--}}
        {{--</div>--}}
        {{--<div class="form-group m-form__group row">--}}
        {{--{!!Form::label('validation','Validation')!!}--}}
        {{--{!!Form::text('validation', old('validation'), ['class'=>'form-control','placeholder'=>'Validation'])!!}--}}
        {{--</div>--}}
        {{--<div class="form-group m-form__group row">--}}
        {{--{!!Form::label('notes','Note')!!}--}}
        {{--{!!Form::textarea('notes', old('notes'), ['class'=>'form-control','placeholder'=>'Note','rows'=>2])!!}--}}
        {{--</div>--}}
        {{--<div class="form-group m-form__group row">--}}
                        ...
                        <div class="m-widget19__content">
                            <div class="m-widget19__header">
                                <div class="m-widget19__user-img">
                                    <img class="m-widget19__img" src="{!! asset('img/user1.jpg') !!}"
                                         alt="">
                                </div>
...
@section('contentFooter')
    <script src="{!! asset(mix('js/admin/dashboard.js')) !!}" type="text/javascript"></script>
@stop
