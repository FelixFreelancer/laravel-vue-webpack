...
<style>
    ...
    .invoice-table tfoot tr td:nth-child(4) span{
        font-weight: 600;
        font-size:16px;
        color:#000;
    }
        ...
        <div class="content">
                ...
                <table class="content-important">
                    <tr>
                        <td>
                            ...
                            <span>#{!! $shipment['invoice_number'] !!}</span>
                        </td>
                        <td>
            ...
            <div class="content__block">
                <table class="invoice-table">
                    ...
                    <tbody>
                        <tr>
                            <td>Shipment #{!! $shipment['parcel_number'] !!}</td>
                            <td>{!! $shipment['user_name'] !!}</td>
                            <td>{!! $shipment['shipping_charge'] !!}</td>
                            <td>{!! $shipment['shipping_charge'] !!}</td>
                        </tr>
                    </tbody>
                    <?php if($shipment['insurance_charge'] != 0.00){  ?>
                      <tbody>
                        <tr>
                          <td>Insurance Charge</td>
                          <td></td>
                          <td>{!! $shipment['insurance_charge'] !!}</td>
                          <td>{!! $shipment['insurance_charge'] !!}</td>
                        </tr>
                      </tbody>
                    <?php  } ?>
