...
<style>
    ...
    .invoice-table tfoot tr td:nth-child(5) span{
        font-weight: 600;
        font-size:16px;
        color:#000;
    }
                ...
                <table class="content-important">
                    <tr>
                        <td>
                            ...
                            <span>#{!! $quotation['invoice_number'] !!}</span>
                        </td>
                        <td>
                ...
                <table class="invoice-table">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td><span>{!! $quotation['total'] !!}</span></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
