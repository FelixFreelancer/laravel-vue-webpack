                                                  ...
                                                  <tr>
                                                    <td style="word-wrap:break-word;font-size:0px;padding:0px;" align="left">
                                                      <div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;"> <p></p>
                                                        ...
                                                        <p>Have we got the right email address to reach you on? To confirm that you own this email address which was just used to signup on <a href="{!! url('/') !!}">{!! config('app.name') !!}</a>, click the button below and we are a go!
                                                      </p>
                                                        <p>
                                                          <a href="{!! url('users/verification/'.$token) !!}" class="btn" mc:disable-tracking="">Confirm My Email Address</a>
                                                        </p>
