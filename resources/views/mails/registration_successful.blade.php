                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td style="width:150px;">
                                                              <img alt="GPF Logo" title="" height="auto" src="{!! asset('img/logo.jpg') !!}"
                                                  ...
                                                  <tr>
                                                    <td style="word-wrap:break-word;font-size:0px;padding:0px;" align="left">
                                                      <div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;"> <p></p>
                                                        ...
                                                        <p class="hero">Welcome to Global Parcel Forward, {!! ucwords(strtolower($user->first_name.' '.$user->last_name)) !!}</p><p></p>
                                                        <p><img src="https://www.globalparcelforward.com/banner-assets/emailer-min.png"
                                                                width="100%" height="100%" alt=""></p>
                                                        <p>We are thrilled you chose to join our global community of shoppers, shipping and forwarding parcels with our service. You are awesome!</p>


                                                        <p>Below is your free personalized shipping address that can be used immediately to shop any UK online store.
                                                        </p>

                                                        <p>
                                                         <address>
   {!! ucwords(strtolower($user->first_name.' '.$user->last_name)) !!}<br/>
   {!! $option['uk_warehouse_address_line_1'] !!}<br/>
   {!! $country->suite_number !!}, {!! $user->customer_code !!} <br/>
   {!! $option['uk_warehouse_address_line_2'] !!}<br/>
   {!! $option['uk_warehouse_country'] !!}
</address>

                                                      <p>
                                                        If you contact us at anytime, we might ask for your Customer Number which is <strong> {!! $user->customer_code !!} </strong> or your Suite ID which is <strong>{!! $country->suite_number !!}</strong>.
                                                        <p>Our <a href="{!! url('/terms-trade') !!}">T&C's</a> can be found here and you can read about our <a href="{!! url('/privacy-policy') !!}">cookies and privacy</a> policies here.</p>
                                                      </p>
                                                        <p>To keep in touch with our latest updates and services, please like our <a href="https://facebook.com/gpforward/">Facebook</a> page, follow us on <a href="https://twitter.com/gpforward">Twitter</a> and check out our <a href="https://www.globalparcelforward.com/blog/">blog!</a>

                                                      <p>
                                                        If you would rather use our personal shopper service to start shipping immediately, great! Login below
                                                      </p>

                                                      </p>
                                                        <p>
                                                          <a href="{!! url("/signin") !!}" class="btn" mc:disable-tracking="">Login to your dashboard</a>
                                                        </p>
                                                        <p>If you don’t know why you got this email, please tell us straight away so we can
                                                          fix this for you.</p>
                                                        <hr style="margin-top: 56px">
                                                        <p class="mb-0">Thank you,</p>
                                                        <p class="mb-0">The GPF Team.</p>
                                                      </div>
                                                    </td>
                                                  </tr>
                                                </tbody>
                                                  ...
                                                  <tr>
                                                    <td style="word-wrap:break-word;font-size:0px;padding:0px;" align="center">
                                                      <div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:14px;line-height:24px;letter-spacing:0.4px;text-align:center;">You can find answers to common questions
                                                        <a href="{!! url('/faqs') !!}">here</a>. And you can always reach us at
                                            ...
                                            <div class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%;">
                                              <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                <tbody>
                                                  <tr>
                                                    <td style="word-wrap:break-word;font-size:0px;padding:0px;" align="center">
                                                      <div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:14px;line-height:24px;letter-spacing:0.4px;text-align:center;">GlobalParcelForward is a trading name of Rehoboth Business Solutions Limited, a company registered in England and Wales with registered
                                                        number 10246097. Our registered office is at Unit 1, Finishing House, Peel Street, Willenhall, West Midlands,
                                                        WV13 2BZ.</div>
                                                    </td>
                                                  </tr>
                                                </tbody>
