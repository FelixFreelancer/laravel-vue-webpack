                                                  ...
                                                  <tr>
                                                    <td style="word-wrap:break-word;font-size:0px;padding:0px;" align="left">
                                                      <div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;"> <p></p>
                                                        ...
                                                        <p class="hero">We have recieved a new package in your warehouse.</p>
                                                        <p>A new package has just been recieved for you at your warehouse address. Please login to view details.
                                                      </p>
                                                        <p>
                                                          <a href="{!! url('/dashboard/#/action-box') !!}" class="btn" mc:disable-tracking="">View Package Details</a>
                                                        </p>
