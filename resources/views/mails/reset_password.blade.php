                                                  ...
                                                  <tr>
                                                    <td style="word-wrap:break-word;font-size:0px;padding:0px;" align="left">
                                                      <div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;"> <p></p>
                                                        ...
                                                        <p class="hero">We recieved a request to reset your password.</p>
                                                        <p>Use the link below to set up a new password for your account. If you did not request to reset your password, ignore this email and the link will expire on its own.
                                                      </p>
                                                      <?php
                                                      $url = url('validate-otp/'.$token);
                                                      if($user['cd_phone_verified_at'] == NULL){
                                                        $url = url('password/reset/'.$token);
                                                      }
                                                      ?>
                                                        <p>
                                                          <a href="{!! $url !!}" class="btn" mc:disable-tracking="">Set New Password</a>
                                                        </p>
