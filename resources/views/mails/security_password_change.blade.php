                                                  ...
                                                  <tr>
                                                    <td style="word-wrap:break-word;font-size:0px;padding:0px;" align="left">
                                                      <div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;"> <p></p>
                                                        ...
                                                        <p>Dear {!! ucwords(strtolower($user->first_name.' '.$user->last_name)) !!},</p>

                                                        <!--<p class="hero">You have successfully reset your password.-->
                                                      </p>
                                                      <p>This is a confirmation that the password to your account was changed at <?php echo date("g:i a")." on ".date("F j, Y"); ?>.</p>
                                                      <p>Didn't change your password? Let us know immediately by contacting support below so we can make sure no one else is trying to access your account. </p>
                                                      <p>  <a href="mailto:support@globalparcelforward.com" class="btn" mc:disable-tracking="">Contact Support</a> </p>
