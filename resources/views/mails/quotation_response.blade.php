                                                  ...
                                                  <tr>
                                                    <td style="word-wrap:break-word;font-size:0px;padding:0px;" align="left">
                                                      <div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;"> <p></p>
                                                        ...
                                                        <p class="hero">Your personal shopper quote is now avaliabe.</p>
                                                        <p>You recently requested a for our personal shopper service with <strong>Quotation ID: {!! $quotation_number !!}</strong>. We are happy to let you know that a quote is now avaliable for your approval. Login to your dashboard to review and make payment.
                                                      </p>
													  <p>
														<a href="{!! url('/dashboard/#/personal-shopper') !!}" class="btn" mc:disable-tracking="">Review And Pay Now</a>
													  </p>
