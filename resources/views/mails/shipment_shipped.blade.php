                                                  ...
                                                  <tr>
                                                    <td style="word-wrap:break-word;font-size:0px;padding:0px;" align="left">
                                                      <div style="cursor:auto;color:#5d7079;font-family:TW-Averta-Regular, Averta, Helvetica, Arial;font-size:16px;line-height:24px;letter-spacing:0.4px;text-align:left;"> <p></p>
                                                        ...
                                                        <p>Great news! Your shipment with tracking number {!! $tracking_no !!} has left our warehouse and it's now en-route to you. To track your shipment, please click on track now button below: </p>
                                                        <p>
                                                          <a href="{!! $tracking_link  !!}" class="btn" mc:disable-tracking="">Track Now</a>
                                                        </p>
